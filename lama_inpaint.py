...
def setup_args(parser):
    parser.add_argument(
        "--input_img", type=str,
        default="D:/medical_paper/Inpaint-Anything/lama/data/train/image/201007240033.jpg",
        help="Path to a single input img",
    )
    parser.add_argument(
        "--input_mask_glob", type=str,
        default="D:/medical_paper/Inpaint-Anything/lama/data/train/image/201007240033-ALN1.jpg",
